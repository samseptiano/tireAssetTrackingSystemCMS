...
<head>
  ...
  <meta name="author" content="">
   <title><?php echo APPNAME ?>  - <?php echo TRXKRSBN ?></title>
...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><?php echo TRXKRSBN ?></li>
            </ol>
          </div>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php foreach($penyebabKerusakanBan as $u){?>
                      <tr>
                         <td><?php echo $u->descDC ?></td>
                        <td><?php echo $u->noKendaraan ?></td>
                        <td><?php echo $u->serialNo ?></td>
                         <td><?php echo $u->posisiBan ?></td>
                         <td><?php echo $u->descAlasan ?></td>
                      <!--    <td> <button type="button" id="viewModal" class="btn btn-warning mb-1" data-toggle="modal"
                     data-target="#exampleModalScrollable" id="#modalScroll">View</button>
                          </td>   -->
                      </tr>
                    <?php }?>
                    </tbody>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a type="button" id="delButton" href="<?php echo base_url()?>User/Home/hapus_ukuranban/" class="btn btn-primary">Ya</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                 ...
                 <form method="post" id="formAct" action="<?php echo base_url()?>User/Home/tambah_ukuranban">
                <div class="modal-body">
  ...
  <script>
    ...
    $('#delButton').attr('href', '<?php echo base_url()?>User/Home/hapus_ukuranban/'+idUkuranBan);
    });
    ...
    $('#formAct').attr('action', '<?php echo base_url()?>User/Home/update_ukuranban');
