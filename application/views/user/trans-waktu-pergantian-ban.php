...
<head>
  ...
  <meta name="author" content="">
   <title><?php echo APPNAME ?>  - <?php echo TRXWKTPGTBN ?></title>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><?php echo TRXWKTPGTBN ?></li>
            </ol>
          </div>
