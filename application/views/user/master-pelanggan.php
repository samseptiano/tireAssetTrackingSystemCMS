                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $p->idCustomer ?></td>
                        <td><?php echo  substr($p->customerName,0,10)."..." ?></td>
                        <td><?php echo substr($p->customerAddress,0,30)."..." ?></td>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="phone" name="customerContact" class="form-control" id="customerContact" placeholder="Kontak Customer">
                    </div>
                    <div class="form-group">
