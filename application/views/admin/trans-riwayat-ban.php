                ...
                <div id="tableRefresh" class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $r->customerUsername ?></td>
                     ...
                     data-descdc="<?php echo $r->descDC ?>"
                      data-nolambung="<?php echo $r->noLambung ?>"
                       data-nokendaraan="<?php echo $r->noKendaraan ?>"
                        data-customerusername="<?php echo $r->customerUsername ?>"
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <input type="text" name="customerUsername" class="form-control" id="customerUsername" placeholder="customerUsername" readonly="readonly">
                    </div>
                     <div class="form-group">
                     ...
                     <div class="row"><div class="col-md-6">
                      ...
                      <input type="text" name="noLambung" class="form-control" id="noLambung" placeholder="noLambung" readonly="readonly">
  ...
  $(document).on("click", "#filterButtons", function () {
      ...
      if(dateAwal>dateAkhir){
        alert("Tanggal awal lebih besar dari tanggal akhir!");
          ...
          $("#tableRefresh").load('riwayatbanperiode/'+tglAwal+'/'+tglAkhir)
      }
