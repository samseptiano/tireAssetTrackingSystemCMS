            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <!--   <a class="dropdown-item" href="#">
                ...
                <a class="dropdown-item" href="#"  data-toggle="modal"
                    data-target="#modalUbahPassword" id="#modalScroll">
          ...
          <div class="modal fade" id="modalUbahPassword" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
              <div class="modal-content">
               ...
               <form method="post" id="formActPassword" action="<?php echo base_url()?>Admin/Login/updatepassword">
                <div class="modal-body">
                  <div class="row">
                   <div class="col-md-4 form-group">
                      <label for="exampleInputEmail1" id="txtMerekBan" >Password Lama</label>
                      <input type="password" name="passwordLama" class="form-control" id="passwordLama">
                      </div>
                      <div class=" col-md-8 form-group">
                      <label for="exampleInputEmail1" id="txtMerekBan" >Password Baru</label>
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" id="submitBtnPassword" class="btn btn-primary">Update</button>
                </div>
              </form>
              </div>
            </div>
