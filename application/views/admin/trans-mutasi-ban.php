                  ...
                  <form method="post" id="formAct" action="<?php echo base_url()?>Admin/Trans/tambah_mutasiban"  enctype="multipart/form-data">
                      <input type="hidden" name="id" class="form-control" id="id">
                          <div class="form-group">
                              ...
                              <input type="text" name="tglMutasi" class="form-control" id="tglMutasis">
                      </div>
                        <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <select class="form-control" id="idDC" name="idDC">
                      ...
                      <input id="txtDC" autocomplete="off" class="txtDC form-control" type="text" name="txtDC" placeholder="txtDC">
                      <input id="idDC" class="idDC form-control" type="hidden" name="idDC" placeholder="idDC">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                              ...
                              <input type="text" name="odometer" autocomplete="off" class="form-control" id="odometer">
                      </div>
                       ...
                       <div class="row">
                        <div class="col-md-6">
                             <div class="form-group">
                              ...
                              <!--   <select class="form-control" id="idBanLepas" name="idBanLepas[]">
                                  ...
                                  <input id="serialBanLepas" autocomplete="off" class="serialBanLepas form-control" type="text" name="serialBanLepas[]" placeholder="serialBanLepas">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                              ...
                              <input id="serialBanPasang" autocomplete="off" class="serialBanPasang form-control" type="text" name="serialBanPasang[]" placeholder="serialBanPasang">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                             <div class="form-group">
                              ...
                              <input type="text" autocomplete="off" name="TTLepas[]" class="form-control" id="TTLepas">
                      </div>
                        </div>
                        <div class="col-md-6">
                             <div class="form-group">
                              <label for="exampleInputEmail1" id="txtMerekBan" >TT Pasang</label>
                              <input type="text"  autocomplete="off" name="TTPasang[]" class="form-control" id="TTPasang">
                      </div>
                        </div>
                      </div>
                        <div class="row">
...
<!--                   <form method="post" id="formAct" action="<?php echo base_url()?>Admin/Master/tambah_mutasiban">
                    ...
                    <select class="form-control" id="idAlasan" name="idAlasan" disabled="disabled">
                             ...
                             <div class="form-group">
                              <label for="exampleInputEmail1" id="txtidBanLepas" >ID Ban Lepas</label>
                                <select class="form-control" id="idBanLepas" name="idBanLepas" disabled="disabled">
                                  ...
                                  <?php foreach($ban as $n){?>
                                    <option value="<?php echo $n->idBan?>"><?php echo $n->serialNo?></option>
                                  <?php }?>
                                  </select>
                      </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                              <label for="exampleInputEmail1" id="txtMerekBan" >Vulk/BB lepas</label>
                              <select class="form-control vulkbbLepas" id="vulkbbLepasDet" name="vulkbbLepas" disabled="disabled">
                              <option value="BB">BB</option>
                              <option value="VULK1">VULK 1</option>
                               <option value="VULK2">VULK 2</option>
                            </select>                      
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                              <label for="exampleInputEmail1" id="txtMerekBan" >Vulk/BB pasang</label>
                              <select class="form-control vulkbbPasang" id="vulkbbPasangDet" name="vulkbbPasang" disabled="disabled">
                              <option value="BB">BB</option>
                              <option value="VULK1">VULK 1</option>
                              <option value="VULK2">VULK 2</option>
 ...
 $(document).on("click", "#viewModal", function () {
    ...
    $(" .modal-body #idAlasan option[value='"+idAlasanLepas+"']").prop("selected", true);
        $(" .modal-body #vulkbbPasangDet option[value='"+vulkbbPasang+"']").prop("selected", true);
    $(" .modal-body #vulkbbLepasDet option[value='"+vulkbbLepas+"']").prop("selected", true);
     $('#lfotoMutasi').attr("src", '<?php echo base_url()?>'+fotoBanLepas);
    $(" .modal-body #idBanLepas option[value='"+idBanLepas+"']").prop("selected", true);
    $(" .modal-body #idBanPasang option[value='"+idBanPasang+"']").prop("selected", true);
      ...
      $.ajax({
        ...
        success: function(response){
          ...
          $.each(response,function(index,data){
                ...
                if($(this).attr('id') == "posisiBan1"){
                  //alert($(this).attr('id'));
                  $("#posisiBan1 option[value='"+$( "#posisiBan").val()+"']").remove();
                }
                else if(posisiBan >1){
                                   // alert($(this).attr('id'));

  				        for(i=1;i<posisiBan;i++){
                    //alert("#posisiBan"+(i)+" = "+$( "#posisiBan"+(i) ).val());

                  $("#posisiBan"+posisiBan+" option[value='"+$( "#posisiBan").val()+"']").remove();
