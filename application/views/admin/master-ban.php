...
<body id="page-top">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo substr($b->idBan,0,6)."..." ?></td>
                                 ...
                                 data-merekban="<?php echo $b->merekBan ?>"
                                  data-idmerekban="<?php echo $b->idMerekBan ?>"
                                   data-idukuranban="<?php echo $b->idUkuranBan ?>"
                                     data-tanggalproduksi="<?php echo $b->tanggalProduksi ?>"
                                    data-idpattern="<?php echo $b->idPattern ?>"
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" id="formAct" action="<?php echo base_url()?>Admin/Master/tambah_ban">
                    ...
                    <select  id="idCustomer" name="idCustomer" class="form-control">
                     ...
                     <div class="form-group">
                      ...
                      <input type="date" name="tanggalProduksi" class="form-control" id="tanggalProduksi" placeholder="tangagl produksi">
                    </div> 
                      <div class="form-group">
                      <label for="exampleInputEmail1">Jenis Telapak</label>
                         <select class="form-control" id="idPattern" name="idPattern">
                        <?php foreach($pattern as $m){ ?>
                        <option value="<?php echo $m->idPattern?>"><?php echo $m->pattern?></option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <label for="exampleInputEmail1">Ukuran Ban</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">FG Vulkan</label>
  ...
  <script>
   ...
   $(document).on("click", "#viewModal", function () {
          ...
          var tanggalProduksi = $(this).data('tanggalproduksi');
    ...
    $(".modal-body #tanggalProduksi").val( tanggalProduksi );
    ...
    $('#fgActiveYN').show();
    $('#txtfgActiveYN').show();
        $(".modal-body #tanggalProduksi").attr('readonly',true );
